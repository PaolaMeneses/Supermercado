...
class CL_Client_Portal
{
    ...
    function cp_set_page_template( $template ){
        ...
        if ( isset( $post ) && isset( $post->post_type ) ){
            if ( $post->post_type === 'private-page' && !empty( $this->options[ 'load-template' ] ) && $this->options[ 'load-template' ] == 'page' ) {
                        ...
                        <tbody>
                            ...
                            <tr class="scp-form-field-wrapper">
                                ...
                                <td>
                                    ...
                                    <p class="description"><?php echo __( 'Click here to view all the pages.', 'client-portal' ); ?></p>
                                </td>
                            </tr>
